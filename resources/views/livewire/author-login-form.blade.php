<div>
    ...
    <form wire:submit.prevent="LoginHandler()" method="post" autocomplete="off" novalidate>
        <div class="mb-3">
            ...
            <input type="email" class="form-control" placeholder="your@example.com" autocomplete="off" wire:model="email">
            @error('email')
        ...
        <div class="mb-2">
            ...
            <label class="form-label">
                ...
                <span class="form-label-description">
                    <a href="{{ route('author.forgot-password') }}">Forgot Password</a>
                </span>
            </label>
